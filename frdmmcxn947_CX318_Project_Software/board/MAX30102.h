...
int initMAX();
int startMAX();
int readFifoMAX(uint32_t *pun_red_led, uint32_t *pun_ir_led);
int sendToMAX(uint8_t uch_addr, uint8_t uch_data);
int readFromMAX(uint8_t uch_addr, uint8_t *puch_data);
int resetMAX();
